...
public sealed unsafe class EstFile : MetaBaseFile {
  ...
  public static ushort GetDefault(Penumbra.Interop.CharacterUtility.InternalIndex index, GenderRace genderRace, ushort setId) {
    //var data  = ( byte* )App.CharacterUtility.DefaultResource( index ).Address;
    //var count = *( int* )data;
    //var span  = new ReadOnlySpan< Info >( data + 4, count );
  ...
  public static ushort GetDefault(CharacterUtility.Index index, GenderRace genderRace, ushort setId)
      => (ushort)0; //GetDefault(Penumbra.Interop.CharacterUtility.ReverseIndices[(int)index], genderRace, setId);

  public static ushort GetDefault(EstManipulation.EstType estType, GenderRace genderRace, ushort setId)
      => (ushort)0; //GetDefault((CharacterUtility.Index)estType, genderRace, setId);
}
